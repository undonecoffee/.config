...
vim.keymap.set('n', '<leader>si', function()
    vim.api.nvim_set_current_dir '~/passwords/documentation/main/03-Physics/99-PDF/'
    vim.cmd 'Yazi cwd'
end)
...
local my_files = {
    { name = "keyboard", path = "~/passwords/dotfiles/keyboard.txt" },
    ...
    { name = "yaziConfig", path = "~/passwords/dotfiles/yazi/yazi.toml" },
    { name = "yaziTheme", path = "~/passwords/dotfiles/yazi/theme.toml" },
    { name = "sxhkd", path = "~/passwords/dotfiles/sxhkd/keybinds/app" },
    { name = "bookmarks", path = "~/passwords/python/search/websites.json" },
    { name = "rofi", path = "~/passwords/dotfiles/rofi/config.rasi" },
    { name = "bspwm", path = "~/passwords/dotfiles/bspwm/bspwmrc" },
    { name = "kitty", path = "~/passwords/dotfiles/kitty/kitty.conf" },
    { name = "tmux", path = "~/passwords/dotfiles/tmux.conf" },
