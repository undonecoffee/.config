...
local my_files = {
    { name = 'keyboardVisual', path = '~/passwords/dotfiles/keyboard.txt' },
    ...
    { name = 'bash', path = '~/passwords/dotfiles/bash/alias.sh' },
    { name = 'bashrc', path = '~/.bashrc' },
    { name = 'yazi', path = '~/passwords/dotfiles/yazi/theme.toml' },
    { name = 'sxhkd', path = '~/passwords/dotfiles/sxhkd/sxhkdrc' },
    { name = 'bspwm', path = '~/passwords/dotfiles/bspwm/bspwmrc' },
    { name = 'kitty', path = '~/passwords/dotfiles/kitty/kitty.conf' },
    { name = 'tmux', path = '~/passwords/dotfiles/tmux/tmux.conf' },
    { name = 'obsidian', path = '~/passwords/dotfiles/obsidian/snippets/Colored Sidebar Items.css' },
}
